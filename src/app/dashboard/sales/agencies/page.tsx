      ...
      <div className="p-4 md:p-6">
        ...
        <Card title="All Agencies" actions={<ViewToggle view={desktopView} onToggle={setDesktopView} />}>
          ...
          <div className="md:hidden space-y-2.5">
            {paginated.length === 0 && <p className="text-center text-gray-400 py-8 text-xs">{search ? "No agencies match your search." : "No agencies yet."}</p>}
            {paginated.map((a) => (
              <div key={a.id} className="border border-gray-200 rounded-lg p-3 bg-white">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <Avatar name={a.name} />
                    <div>
                      <div className="font-medium text-[12.5px] text-gray-800">{a.agency}</div>
                ...
                <div className="grid grid-cols-3 gap-2 mb-2 text-[11px]">
                  ...
                  <div><span className="text-gray-400">Clients</span><div className="text-gray-700 font-medium">{a.clientCount}</div></div>
                  <div><span className="text-gray-400">Commission</span><div className="text-gray-700 font-medium">{a.commission}%</div></div>
                </div>
          ...
          {desktopView === "cards" && (
            <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-2.5">
              {paginated.length === 0 && <p className="col-span-full text-center text-gray-400 py-8 text-xs">{search ? "No agencies match your search." : "No agencies yet."}</p>}
              {paginated.map((a) => (
                <div key={a.id} className="border border-gray-200 rounded-lg p-3 bg-white">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
